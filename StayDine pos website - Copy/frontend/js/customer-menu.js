...
async function loadMenuItems(restaurantId) {
  try {
    if (typeof MenuAPI === 'undefined' || !MenuAPI.getMenuItems) {
      throw new Error('MenuAPI is not available. Ensure api-client.js is loaded before customer-menu.js.');
    }
    ...
    const html = `
      <div class="menu-item" data-id="${item._id}">
        <div class="menu-item-image">
          <img src="${item.image || 'data:image/svg+xml;charset=utf-8,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220%200%20200%20150%22%3E%3Crect fill=%22%23ddd%22 width=%22200%22 height=%22150%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 font-size=%2220%22 fill=%22%23999%22 text-anchor=%22middle%22 dominant-baseline=%22middle%22%3ENo%20Image%3C/text%3E%3C/svg%3E'}" alt="${item.name}">
